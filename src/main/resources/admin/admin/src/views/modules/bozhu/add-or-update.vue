...
export default {
  data() {
	...
	jianjie : false,
      ...
      rules: {
          bozhuhao: [
                { required: true, message: '博主号不能为空', trigger: 'blur' },
          ],
          bozhuming: [
                { required: true, message: '博主名不能为空', trigger: 'blur' },
          ],
          mima: [
  ...
  methods: {
	...
	this.ruleForm.jianjie = this.ruleForm.jianjie.replace(reg,'../../../springboot45y5d/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
